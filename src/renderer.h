...
namespace RenderToy
{
    ...
    private:
        const Vector3f Radiance(const Vector3f &ray_src, const Vector3f &ray_dir, const Triangle *last_hit, RayState &state, const int depth, const float last_bsdfpdf) const;
